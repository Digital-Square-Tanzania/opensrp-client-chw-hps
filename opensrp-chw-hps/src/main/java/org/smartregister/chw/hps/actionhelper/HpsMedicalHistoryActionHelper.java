...
public class HpsMedicalHistoryActionHelper implements BaseHpsVisitAction.HpsVisitActionHelper {
    ...
    public HpsMedicalHistoryActionHelper(Context context, MemberObject memberObject) {
