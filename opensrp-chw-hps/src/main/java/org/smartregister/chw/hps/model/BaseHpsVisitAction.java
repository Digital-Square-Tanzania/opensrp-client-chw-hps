...
import org.smartregister.chw.hps.fragment.BaseHpsVisitFragment;
 ...
 */
public class BaseHpsVisitAction {
    ...
    private BaseHpsVisitFragment destinationFragment;
    private String formName;
    private String jsonPayload;
    private String selectedOption;
    private HpsVisitActionHelper hpsVisitActionHelper;
    private Map<String, List<VisitDetail>> details;
    private Context context;
    private Validator validator;

    private BaseHpsVisitAction(Builder builder) throws ValidationException {
        ...
        this.hpsVisitActionHelper = builder.hpsVisitActionHelper;
        ...
        try {
            if (StringUtils.isBlank(jsonPayload) && StringUtils.isNotBlank(formName)) {
                ...
                if (details != null && details.size() > 0) {
                    HpsJsonFormUtils.populateForm(jsonObject, details);
                }

                jsonPayload = jsonObject.toString();
            }

            if (hpsVisitActionHelper != null) {
                hpsVisitActionHelper.onJsonFormLoaded(jsonPayload, context, details);
                String pre_processed = hpsVisitActionHelper.getPreProcessed();
                ...
                String sub_title = hpsVisitActionHelper.getPreProcessedSubTitle();
                if (StringUtils.isNotBlank(sub_title)) {
                    this.subTitle = sub_title;
                }

                ScheduleStatus status = hpsVisitActionHelper.getPreProcessedStatus();
                if (status != null) {
    ...
    private void onPayloadReceivedNotifyHelper(String jsonPayload) {
        ...
        hpsVisitActionHelper.onPayloadReceived(jsonPayload);

        String sub_title = hpsVisitActionHelper.evaluateSubTitle();
        if (sub_title != null) {
            setSubTitle(sub_title);
        }

        String post_process = hpsVisitActionHelper.postProcess(jsonPayload);
        if (post_process != null) {
            this.jsonPayload = hpsVisitActionHelper.postProcess(jsonPayload);
        }

        hpsVisitActionHelper.onPayloadReceived(this);
    }
    ...
    public BaseHpsVisitFragment getDestinationFragment() {
        return destinationFragment;
    }

    public void setDestinationFragment(BaseHpsVisitFragment destinationFragment) {
    ...
    public HpsVisitActionHelper getHpsVisitActionHelper() {
        return hpsVisitActionHelper;
    }

    public void setHpsVisitActionHelper(HpsVisitActionHelper hpsVisitActionHelper) {
        this.hpsVisitActionHelper = hpsVisitActionHelper;
    }
    ...
    public void evaluateStatus() {
        ...
        if (getHpsVisitActionHelper() != null) {
            setActionStatus(getHpsVisitActionHelper().evaluateStatusOnPayload());
        }
    }
    ...
    public interface HpsVisitActionHelper {
         ...
         */
        void onPayloadReceived(BaseHpsVisitAction hpsVisitAction);
    }
    ...
    public static class Builder {
        ...
        public Builder withDestinationFragment(BaseHpsVisitFragment destinationFragment) {
            this.destinationFragment = destinationFragment;
            return this;
        }
        ...
        public Builder withHelper(HpsVisitActionHelper hpsVisitActionHelper) {
            this.hpsVisitActionHelper = hpsVisitActionHelper;
            return this;
        }
        ...
        public BaseHpsVisitAction build() throws ValidationException {
            return new BaseHpsVisitAction(this);
        }
    }
