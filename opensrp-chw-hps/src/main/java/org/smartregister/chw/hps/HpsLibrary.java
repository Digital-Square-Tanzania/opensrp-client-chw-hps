package org.smartregister.chw.hps;
...
public class HpsLibrary {
    private static HpsLibrary instance;
    ...
    public void setSubmitOnSave(boolean submitOnSave) {
        HpsLibrary.submitOnSave = submitOnSave;
    }
    ...
    public static void init(Context context, Repository repository, int applicationVersion, int databaseVersion) {
        if (instance == null) {
            instance = new HpsLibrary(context, repository, applicationVersion, databaseVersion);
        }
    }

    public static HpsLibrary getInstance() {
        if (instance == null) {
    ...
    private HpsLibrary(Context contextArg, Repository repositoryArg, int applicationVersion, int databaseVersion) {
