...
public class HpsActionHelper implements BaseHpsVisitAction.HpsVisitActionHelper {
    ...
    public HpsActionHelper(Context context, MemberObject memberObject) {
    ...
    public String getPreProcessed() {
        try {
            ...
            String is_client_diagnosed_with_any = HpsMedicalHistoryActionHelper.is_client_diagnosed_with_any;
            String any_complaints = HpsMedicalHistoryActionHelper.any_complaints;
            String known_allergies = HpsMedicalHistoryActionHelper.known_allergies;
            String any_hematological_disease_symptoms = HpsMedicalHistoryActionHelper.any_hematological_disease_symptoms;
            String complications_previous_surgical = HpsMedicalHistoryActionHelper.complications_previous_surgical;
            String type_of_blood_for_glucose_test = HpsMedicalHistoryActionHelper.type_of_blood_for_glucose_test;
            String blood_for_glucose = HpsMedicalHistoryActionHelper.blood_for_glucose;
            String blood_for_glucose_test = HpsMedicalHistoryActionHelper.blood_for_glucose_test;
            String diagonised_others = HpsMedicalHistoryActionHelper.client_diagnosed_other;
            String genital_examination = HpsPhysicalExamActionHelper.genital_examination;
            String diastolic = HpsPhysicalExamActionHelper.diastolic;
            String systolic = HpsPhysicalExamActionHelper.systolic;
