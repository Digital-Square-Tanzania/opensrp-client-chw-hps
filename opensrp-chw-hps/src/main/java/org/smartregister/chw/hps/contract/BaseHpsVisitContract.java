...
public interface BaseHpsVisitContract {
    interface View extends VisitView {
        ...
        void startForm(BaseHpsVisitAction hpsHomeVisitAction);

        void startFormActivity(JSONObject jsonForm);

        void startFragment(BaseHpsVisitAction hpsHomeVisitAction);
        ...
        Map<String, BaseHpsVisitAction> getHpsVisitActions();
        ...
        void initializeActions(LinkedHashMap<String, BaseHpsVisitAction> map);
    ...
    interface Interactor {
        ...
        void submitVisit(boolean editMode, String memberID, Map<String, BaseHpsVisitAction> map, InteractorCallBack callBack);
    }
    ...
    interface InteractorCallBack {
        ...
        void preloadActions(LinkedHashMap<String, BaseHpsVisitAction> map);
