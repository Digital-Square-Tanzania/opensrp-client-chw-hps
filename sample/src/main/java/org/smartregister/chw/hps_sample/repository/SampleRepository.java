package org.smartregister.chw.hps_sample.repository;
...
import org.smartregister.chw.hps_sample.BuildConfig;
import org.smartregister.chw.hps_sample.application.SampleApplication;
...
public class SampleRepository extends Repository {
    ...
    public void onCreate(SQLiteDatabase database) {
        ...
        HpsLibrary.getInstance().visitRepository().createTable(database);
        HpsLibrary.getInstance().visitDetailsRepository().createTable(database);
